...
#include <lg/pattern_formatter.h>
#endif
...
#pragma warning(disable : 4127) // consider using 'if constexpr' instead
    ...
    static const char *basename(const char *filename)
    {
        ...
        else
        {
            ...
            const auto it = std::ranges::find_first_of(begin, end, std::begin(os::folder_seps), std::end(os::folder_seps) - 1);
...
class full_formatter_orignal final : public flag_formatter
{
public:
    explicit full_formatter_orignal(padding_info padinfo)
        : flag_formatter(padinfo)
    {}
...
SPDLOG_INLINE void pattern_formatter::handle_flag_(char flag, details::padding_info padding)
{
    ...
    default: // Unknown flag appears as is
        ...
        // lg::set_pattern("[%10!] %v") => "[      main] some message"
        // lg::set_pattern("[%3!!] %v") => "[mai] some message"
        else
        {
