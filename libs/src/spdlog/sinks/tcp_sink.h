...
class tcp_sink : public lg::sinks::base_sink<Mutex>
{
public:
...
protected:
    void sink_it_(const lg::details::log_msg &msg) override
    {
        ...
        lg::sinks::base_sink<Mutex>::formatter_->format(msg, formatted);
...
using tcp_sink_st = tcp_sink<lg::details::null_mutex>;
