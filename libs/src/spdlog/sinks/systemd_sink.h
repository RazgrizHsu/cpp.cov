...
public:
    //
    systemd_sink()
        : syslog_levels_{{/* lg::level::trace      */ LOG_DEBUG,
              /* lg::level::debug      */ LOG_DEBUG,
              /* lg::level::info       */ LOG_INFO,
              /* lg::level::warn       */ LOG_WARNING,
              /* lg::level::err        */ LOG_ERR,
              /* lg::level::critical   */ LOG_CRIT,
              /* lg::level::off        */ LOG_INFO}}
    {}
