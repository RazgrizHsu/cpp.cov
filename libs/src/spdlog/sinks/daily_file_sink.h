 ...
 * Usages:  
 *    auto sink =  std::make_shared<lg::sinks::daily_file_format_sink_mt>("myapp-%Y-%m-%d:%H:%M:%S.log", hour, minute);"
 *    auto logger = lg::daily_logger_format_mt("loggername, "myapp-%Y-%m-%d:%X.log", hour,  minute)"
 *  
 */
...
private:
    ...
    tm now_tm(log_clock::time_point tp)
    {
        ...
        return lg::details::os::localtime(tnow);
    }
...
// factory functions
//
template<typename Factory = lg::synchronous_factory>
