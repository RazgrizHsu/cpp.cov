...
public:
    ...
    void swap( lg::logger &other) SPDLOG_NOEXCEPT;
    ...
    template<class T, typename std::enable_if<
                          std::is_convertible<const T &, lg::string_view_t>::value && !fmt::is_compile_string<T>::value, int>::type = 0>
    ...
    template<class T, typename std::enable_if<!std::is_convertible<const T &, lg::string_view_t>::value &&
...
protected:
    ...
    lg::level_t level_{ level::trace}; //raz:本來預設是info
    lg::level_t flush_level_{ level::off};
